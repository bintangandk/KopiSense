...
@section('content')
    <div class="container-xxl grow container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data /</span> Data Suhu</h4>
        <div class="row">
            <div class="d-flex justify-content-start align-items-center">
                ...
                <p class="font-weight-bold mb-0">Arahkan Kursor untuk melihat nilai suhu </p>
            </div>
